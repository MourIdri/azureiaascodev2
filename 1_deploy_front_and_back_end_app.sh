...
az vm availability-set create --resource-group RGAZESSENTIALS --name Availability-Set-Front --platform-fault-domain-count 3 --platform-update-domain-count 3
...
# Create an availability set.
az vm availability-set create --resource-group RGAZESSENTIALS --name Availability-Set-back-end-2 --platform-fault-domain-count 3 --platform-update-domain-count 3
